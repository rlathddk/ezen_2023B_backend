...
public class Step3 {
    public static void main(String[] args) {
        ...
        // 3. 문자열 대체 : 문자열.replace();
            // 매개변수 : 변경할문자열, 새로운문자열, 새로운문자열 / 반환값 : 대체된새로운문자열(String)
        ...
        String secondNum = ssn.substring(7); // 7~부터 마지막인덱스 추출
        System.out.println("secondNum =" + secondNum);

        // 5. 문자열 찾기 : 문자열.indexOf()
            // 매개변수 : "찾을문자열" / 반환타입 : 찾은문자열의 인덱스 번호[있으면 0이상, 없으면-1] (int)
        // --- index 와 substring --- //
        ...
        if(location != -1){ // -1이라는 인덱스는 존재 x 고로 없다
        ...
        String board = "1. 자바 학습, 참조 타입 String을 학습합니다.,홍길동";
                        // 1    자바 학습       참조 타입 String을 학습니다. 홍길동
