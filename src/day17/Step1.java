...
public class Step1 {
    public static void main(String[] args) {
        ...
        try{// 만약에 해당 연동할 db서버의 정보가 잘못되거나 db서버쪽에 문제가 발생했을 때
            ...
            System.out.println("[시스템오류] : DB서버와 연동이 실패했습니다."+e);
        }
    } // m e
} // c e
...
/*
    ...
    // 1. Class.forName() : 현재 프로젝트내 클래스 찾고 메모리로 로딩한다.
        Class.forName("com.mysql.cj.jdbc.Driver");
            ...
            // 2. 해당 폴더내 driver 클래스를 찾는 과정에서 오류가 발생할 수 있다
                // - classNotFoundException : 클래스를 찾지 못했다는 뜻
                // 예외/오류 처리 : 1. 일반예외 2. 실행예외
        // com 폴더내 mysql 폴더내 cj 폴더내 jdbc 폴더내 driver 존재
