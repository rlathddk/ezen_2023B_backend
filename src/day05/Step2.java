...
public class Step2 {
    public static void main(String[] args) {
        ...
        /*
            ...
            2. 특징
                1. 배열은 같은 타입의 값만 저장
                    int = [57, "가"] 불가능 // 같은 타입만 저장 가능
                2. [고정길이]배열의 길이는 선언된 이후 늘리거나 줄일 수 없다.
                    int = [57. 62. 97] : 항목/요소를 추가/삭제할 수 없다.
            ...
            4. 값 목록으로 배열 선언
                ...
                - 배열생성2 : 타입[] 변수명 = new 타입[길이];
                    - 배열에 넣을 초기값을 모르고 배열의 길이(최대저장개수)알고 있을 때 사용
            ...
            8. 배열 항목/요소 값 수정
                    - 배열명[인덱스] = 새로운값;
            9. 배열 항목/요소 값 삭제 [항목/요소 위치 삭제는 없고 초기값 넣어서 초기화 한다]
                    - 배열명[인덱스] = 각 타입의 초기값
                                     null, 0, 0.0, false
        */
        ...
        // 2. 배열의 각 요소/항목의 값 호출
        System.out.println("season : " + season); // 기본타입(7가지+String)말고 참조타입 호출시 주소값이 나옴
    ...
    //    System.out.println("season[4] : " + season[4]); // Index 4 out of bounds for length 4 // 인덱스 4번은 없음
        ...
        // 1. int 3개를 저장할 수 있는 배열 선언
            // new연산자 사용시 초기값 !!! 정수: 0 실수: 0.0 논리:false 클래스 : null
