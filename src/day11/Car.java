...
public class Car {
    ...
    // 클래스 멤버
        // 1. (public, (default), private) (정적/인스턴스, final, 상수)필드
    private int speed; // private 인스턴스 필드 // 관례적으로 private씀 안전을 위해
    private boolean stop ; // private 인스턴스 필드
        // 2. (public, (default), private) 생성자
        // 3. (public, (default), private) (정적/인스턴스)메소드
